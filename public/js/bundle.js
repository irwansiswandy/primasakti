...
exports.default = {
  props: ['order'],
  computed: {
    working_team: function working_team() {
    ...
    deadline_less_than_1_day: function deadline_less_than_1_day() {
    ...
    deadline_less_than_2_days: function deadline_less_than_2_days() {
      var deadline_in_hours = moment().diff(this.order.deadline, 'hours') * -1;
    ...
    deadline_more_than_2_days: function deadline_more_than_2_days() {
      var deadline_in_hours = moment().diff(this.order.deadline, 'hours') * -1;
      if (deadline_in_hours > 48) {
        return true;
      } else {
    ...
    label_urgent: function label_urgent() {
    ...
    label_warning: function label_warning() {
...
var orderListVue = new Vue({
	...
	computed: {
		total_order: function total_order() {
	...
	methods: {
		get_orders: function get_orders() {
			...
			return this.$http.get('http://' + document.location.host + '/workshop/order_list/get_orders').then(function (response) {
				return _this.$set('orders', response.data);
			}, function (response) {
				return _this.get_orders();
			});
		}
	},
	components: {
...
},{"./components/orderlist.vue":69,"vue":67}]},{},[70]);
